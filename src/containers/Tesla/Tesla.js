    ...
    return (
        <div className="flex justify-center mt-[50px]">
            <div className="flex flex-1 items-center justify-center max-w-6xl w-full px-4">
                <div className="flex-shrink-0 ml-8 w-">
                    <img src={TeslaImg} alt="Icon3" width="auto" height="auto"></img>
                </div>

                <div className="flex-1">
                    <h1 className="text-neutral-d_grey text-headline-2 mb-6 font-medium">
                    ...
                    <p className="font-regular text-neutral-l_grey text-body-2 mb-6">
                        British Dragon Boat Racing Association
                    </p>
                    
                    <div className="flex items-center">
                        <img src={Logos} alt="Logos" className="mr-4" />
                        <p className="text-primary text-headline-4 font-regular">
